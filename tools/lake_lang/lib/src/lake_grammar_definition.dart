...
class LakeGrammarDefinition extends GrammarDefinition {
  ...
  // [13] Field ::=
  //  FieldID? FieldReq? FieldType Identifier ('=' ConstValue)? ListSeparator?
  Parser field() =>
  ...
  Parser doubleConstant() {
    ...
    final expPart = (char('E') | char('e')) & ref0(intConstant);

    return ref1(
      token,
      (sign &
              ref0(digit).star() &
              ((char('.') & ref0(digit).plus() & expPart.optional()) | expPart))
          .flatten(),
    );
  }
