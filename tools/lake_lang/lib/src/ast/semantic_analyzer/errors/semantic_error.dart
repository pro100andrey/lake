...
enum DiagnosticCode {
  ...
  String? get helpLink => 'https://lakelang.org/docs/diagnostic/$id';
}
...
abstract base class Diagnostic {
  ...
  ///
  /// - Parameters:
  ///   - [primarySpan]: The main location in the source code where the
  /// diagnostic originates. This is the most important piece of location
  ///     information.
...
final class GenericDiagnostic extends Diagnostic {
  ...
  const GenericDiagnostic(
    ...
    super.code,
    super.labels,
  }) : super(primarySpan: span, message: message);
}
...
final class DuplicateDeclarationDiagnostic extends Diagnostic {
  ...
  DuplicateDeclarationDiagnostic(
    ...
    SourceSpan? previousDeclarationSpan,
        ...
        labels: [
          if (previousDeclarationSpan != null)
            (
...
final class KeywordAsIdentifierDiagnostic extends Diagnostic {
  ...
  const KeywordAsIdentifierDiagnostic(String identifier, SourceSpan span)
    : super(
        primarySpan: span,
        message:
